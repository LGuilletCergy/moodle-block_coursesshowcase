 ...
 *
 * File : lang/fr/block_coursesshowcase.php
 * French text strings
 *
 */
...
$string['studentslist'] = 'Liste des inscrits';
$string['wantedlist'] = 'Demandes supplémentaires';
$string['checkcohorts'] = 'Vérifier les cohortes';
