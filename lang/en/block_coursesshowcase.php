 ...
 *
 * File : lang/en/block_coursesshowcase.php
...
$string['studentslist'] = 'Enroled students';
$string['wantedlist'] = 'Students who wanted to enrol';
$string['checkcohorts'] = 'Check cohorts';
